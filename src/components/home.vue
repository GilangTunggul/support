        ...
        <v-list>
          <v-list-item>
            ...
            <v-list-item-content>
              ...
              <v-list-item-subtitle>Students At Cambridge University</v-list-item-subtitle>
            </v-list-item-content>
...
<template>
      <v-content>
      <section>
        <v-parallax src="@/components/Image/gambar6.png" height="600">
          <v-layout
            column
            align-center
            justify-center
            class="white--text"
          >
            <img src="@/components/Image/logo1.png" height="280">
            <h1 class="font-weight-bold display-3 black--text">Support Ticketing System</h1>
            <div class="subheading mb-6 text-center black--text">Easy to Create Ticket</div>
            <v-btn
              class="mt-12"
            ...
            <v-container grid-list-xl>
              <v-layout row wrap align-center>
                ...
                <v-flex xs12 md4>
                  <v-card flat class="transparent">
                    <v-card-text class="text-center">
                      <v-icon x-large class="orange--text text--lighten-2">mdi-flash</v-icon>
                    </v-card-text>
                    <v-card-title primary-title class="layout justify-center">
      ...
      <section>
        <v-parallax src="@/components/Image/gambar3.jpg" height="380">
          <v-layout column align-center justify-center>
            <div class="font-weight-bold display-2 black--text">Ticketing has never been easier</div>
            <em>Kick-start your Ticket today</em>
            <v-btn
              class="mt-12"
              color="orange accent-3"
              dark
              ...
              <v-card flat class="transparent">
                ...
                <v-list class="transparent">
                  <v-list-item>
                    ...
                    <v-list-item-content>
                      <v-list-item-title>081546485561</v-list-item-title>
                    </v-list-item-content>
                  </v-list-item>
                  <v-list-item>
                    <v-list-item-action>
                    ...
                    <v-list-item-content>
                      <v-list-item-title>Yogyakarta</v-list-item-title>
                    </v-list-item-content>
                  </v-list-item>
